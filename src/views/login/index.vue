...
<!--   <el-alert
        title="VUE技术交流组基于vue-admin-template进行修改,欢迎大家使用!(数据为本地mock),更多介绍请点击下方技术支持"
        type="success"
     >
    </el-alert> -->
	
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
		<!-- <div style="width: 100%;margin: 30px 0;" class=" flex_jufy_center">
			<img src="../../assets/logo.png" style="width: 200px; text-align: center;" />
		</div> -->
